...
from config import DEVICE, TYPE_FORGET


def evaluate(model, data_loader, label_encoder, type_eval):
    ...
    plt.show()
    plt.savefig(f"confusion_matrix_{type_eval}_forget{TYPE_FORGET}.png", bbox_inches='tight')
